    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonEnter = findViewById<LoadingButton>(R.id.login_btn_enter)
            buttonEnter.setOnClickListener {
              ...
              findViewById<TextInputLayout>(R.id.login_edit_email_input).error = "Este email é inválido!"
              findViewById<TextInputLayout>(R.id.login_edit_password_input).error = "Senha incorreta!"
